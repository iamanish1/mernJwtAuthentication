        ...
        <div className=" container mx-auto  p-4">
            <div className="bg-white p-6 w-full max-w-md mx-auto rounded shadow-md"> 
                  <div className="flex justify-center">
                    <h1 className="text-3xl font-semibold font-sans uppercase">Login account</h1>
                  </div>
                ...
                >Dont have account ? <Link to={"/singup"} className=' hover:text-blue-400 hover:underline'
